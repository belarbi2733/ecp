...
// Get a list of all the algoRun files to include
Object.keys(window.__karma__.files).forEach(function(file) {
  if (TEST_REGEXP.test(file)) {
    // Normalize paths to RequireJS module names.
    // If you require sub-dependencies of algoRun files to be loaded as-is (requiring file extension)
...
require.config({
  ...
  // dynamically load all algoRun files
  deps: allTestFiles,
